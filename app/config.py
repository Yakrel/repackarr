...
class Settings(BaseSettings):
    ...
    ALLOWED_INDEXERS: str = "NoNaMe Club, RuTracker.org"
    ...
    @property
    def allowed_indexers_list(self) -> list[str]:
        """Get allowed indexers as lowercase list."""
        return [a.strip().lower() for a in self.ALLOWED_INDEXERS.split(",") if a.strip()]
